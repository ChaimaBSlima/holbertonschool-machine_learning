#!/usr/bin/env python3
""" Task 22: 22. Train DeepNeuralNetwork """
import numpy as np
...
class DeepNeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        ...
        Args:
            X (numpy.ndarray): Array with shape (nx, m) containing
            the input data.
                - nx (int): Number of input features.
                - m (int): Number of examples.
            ...
            during training. Default is 5000.
        ...
        Returns:
            tuple: A tuple containing:
                - numpy.ndarray: Array with shape (1, m)
                of the network's predicted labels.
        ...
        Raises:
            ...
            or `alpha` is less than or equal to 0.
        """
